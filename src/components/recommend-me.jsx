...
const Dropdown = () => {
  ...
  const hospitals = [
    {
      name: "S A S Grewal Multispeciality Hospital",
      latitude: 30.8938128,
      longitude: 75.8273895
    },

    {
      name: "Aastha Kidney And Super Speciality Hospital",
      latitude: 30.909848,
      longitude: 75.8178199
    },

    {
      name: "Christian Medical College And Hospital",
      latitude: 30.9108987,
      longitude: 75.8610857
    },

    {
      name: "SPS Apollo Hospital",
      latitude: 30.8839123,
      longitude: 75.8874423
    },
...

    {
      ...
      latitude: 30.8938128,
      longitude: 75.8248146
    },

    {
      name: "Sidhu Hospital Pvt Ltd",
      latitude: 30.6610484,
      longitude: 76.2553299
    },

    {
      name: "Suman Hospital",
      latitude: 30.8926352,
      longitude: 75.8419851
    },

    {
      name: "Indo German Hospital",
      latitude: 30.700414,
      longitude: 76.2278651
    },

    {
      name: "Satyam Hospital",
      latitude: 30.913938,
      longitude: 75.8723329
    },
...

    {
      ...
      latitude: 30.9163014,
      longitude: 75.8315169
    },

    {
      name: "Vasan Eye Care Hospital",
      latitude: 30.8995274,
      longitude: 75.8114928
    },
                ...
                /* Hover Part */}
                    ...
                    >
                      ...
                      <div className=' hospital-buttons mt-3'>
                        ...
                        <button
                          className="btn btn-sm"
                          onClick={() => openLocation(hospitals[index].latitude, hospitals[index].longitude)}
                          style={{ backgroundColor: '#c32148', color: 'white' }}
                        >
                          Location
                        </button>
